            ...
            <div style={{ height: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                >
                    ...
                    <div style={{ display: 'flex', gap: '1.25rem' }}>
                        <button className="btn btn-primary" style={{ flex: 1, height: '60px', borderRadius: '18px', fontSize: '1rem', background: 'var(--warning)', border: 'none' }} onClick={() => window.print()}><Printer size={22} color="green" /> {t.printInvoice}</button>
